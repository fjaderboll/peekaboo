...
class Sounds:
	...
	def play_random_sound(self, min_tones=2, max_tones=5):
		...
		#print(random_tones)
		self.buzzer.play_song(random_tones, tone_delay=0.2)

	def play_startup(self):
		self.buzzer.play_song(['G7', 'A7', 'B7', 'C8', 'D8'], tone_delay=0.1)

	def play_found_someone(self):
		self.buzzer.play_song(['D8', 'G7', 'D8', 'G7'], tone_delay=0.1)

	def play_lost_someone(self):
		self.buzzer.play_song(['B7'], tone_delay=0.1)
	
	def play_startup_end(self):
		self.buzzer.play_song(['C6', 'C8', 'P', 'C8'], tone_delay=0.1)
